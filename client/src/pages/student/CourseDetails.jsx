...
const CourseDetails = () => {
  ...
  const { allCourses, calculateRating, calculateNoLectures, calculateCourseDuration, calculateChapterTime, currency, backendUrl, userData, getToken } = useContext(AppContext)
        ...
        <div className='max-w-[424px] z-10 shadow-custom-card rounded-t md:rounded-none overflow-hidden bg-white min-w-[300px] sm:min-w-[420px]'>
          ...
          <div className='p-5'>
            <div className='flex items-center gap-2'>
              ...
              <p className='text-red-500'><span className='font-bold'>5 days</span> left at this price!</p>
            </div>
            ...
            <div className='pt-6'>
              <p className='md:text-xl text-lg font-medium text-gray-800'>What's in the course?
